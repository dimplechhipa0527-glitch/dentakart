      ...
      <header className="sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-850 shadow-xs pt-[env(safe-area-inset-top)]">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-1.5 sm:py-2">
          ...
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            {/* GPS Location Pill (Compact on mobile) */}
            <div className="flex items-center min-w-0 shrink">
              <button
                onClick={() => setIsLocationModalOpen(true)}
                className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200/70 dark:hover:bg-slate-800 px-2 py-1 rounded-full text-xs font-semibold text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-700 transition group max-w-[125px] sm:max-w-[220px]"
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs px-3 py-1.5 rounded-xl shadow-md shadow-emerald-600/20 transition cursor-pointer"
              >
